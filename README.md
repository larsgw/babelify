# babelify [![Build Status](https://github.com/larsgw/babelify/actions/workflows/action.yml/badge.svg?branch=main)](https://github.com/larsgw/babelify/actions/workflows/action.yml)
